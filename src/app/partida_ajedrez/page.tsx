    ...
    <main className='w-screen h-screen flex flex-col'>
      ...
      <div className='flex w-full justify-center items-center bg-red-500 flex-1'>
        <div className='flex w-50/100 bg-pink-500 gap-x-10'>
            {
              tipo_partida === 'cpu' ? <TableroAjedrezCPU mostrar_tabla_movimientos={actualizarHistorialMovimientos}/> :
              tipo_partida === 'jugador' ? <TableroAjedrez nombre_jugador={nombreUsuario} mostrar_tabla_movimientos={actualizarHistorialMovimientos} /> : 
              null /* Tablero para repeticion */
            }
            <div className='flex w-4/10 bg-blue-500'>
              <TablaMovimientos lista_movimientos={historialMovimientos} />
            </div>
        </div>
      </div>
      <Footer />
